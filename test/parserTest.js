...
describe('Parse form conditons',()=>{
    it('should be able to parse and return the result for a single if statement', () => {
            let content = "Bahmni.ConceptSet.FormConditions.rules " +
                ...
                ": function FSTGOutcomesFor1stStageSurgicalValidation(formName, formFieldValues)" +
                " {\r\n        var conditions = {\r\n            show: [],\r\n            hide: []\r\n        };" +
                "\r\n        var conditionConcept = formFieldValues[\'Concept 1\'];\r\n        " +
                "if (conditionConcept.length >= 2) {\r\n           " +
                "conditions.hide.push(\"ConceptA\");\r\n        }\r\n    }\r\n}";
            //console.log(content);
            let finaltree = parseContent(content);
            //console.log(JSON.stringify(finaltree));
            let parsedContent= finaltree['FSTG, Outcomes for 1st stage surgical validation'];
    ...
    it('should be able to parse and return the result for a single if statement in multiple concept', () => {
        let content ="\'use strict\';\r\n\r\nBahmni.ConceptSet.FormConditions.rules = { \/\/This is a constant that Bahmni expects\r\n    \'Baseline, Employment within the past year\': function BaselineEmploymentWithinThePastYear(formName, formFieldValues) {\r\n        var conditions = { enable: [], disable: [] };\r\n        var conditionConcept = formFieldValues[\'Baseline, Employment within the past year\'];\r\n        if (conditionConcept == \"Other\") {\r\n            conditions.enable.push(\"Baseline, Other employment\");\r\n        }\r\n        return conditions;\r\n    },\r\n    \'Baseline, Prison\': function BaselinePrison(formName, formFieldValues) {\r\n        var conditions = { enable: [], disable: [] };\r\n        var conditionConcept = formFieldValues[\'Baseline, Prison\'];\r\n        if (conditionConcept == \"True\") {\r\n            conditions.enable.push(\"Baseline, Is prison past or present\");\r\n        }\r\n        return conditions;\r\n    }\r\n};";
        let finaltree = parseContent(content);
        let parsedContent1= finaltree['Baseline, Employment within the past year'];
        let parsedContent2= finaltree['Baseline, Prison'];
        assert.equal(parsedContent1[0].condition,"if selected answers for Baseline, Employment within the past year is equal to  Other" );
    ...
    it('should be able to parse and return the result for a if else statement', () => {
        let content ="Bahmni.ConceptSet.FormConditions.rules = {      \/\/This is a constant that Bahmni expects\r\n    \'Baseline, Employment within the past year\': function (formName, formFieldValues) {\r\n        var conditions = {enable: [], disable: []};\r\n        var conditionConcept = formFieldValues[\'Baseline, Employment within the past year\'];\r\n        if (conditionConcept == \"Other\") {\r\n            conditions.enable.push(\"Baseline, Other employment\");\r\n        }\r\n        else {\r\n            conditions.disable.push(\"Concept D\",\"Concept X\");\r\n        }\r\n        return conditions;\r\n    }\r\n}";
        let finaltree = parseContent(content);
        let parsedContent= finaltree['Baseline, Employment within the past year'];
        assert.equal(parsedContent[0].condition,"if selected answers for Baseline, Employment within the past year is equal to  Other" );
        assert.equal(parsedContent[0].nestedConditions, undefined);
